...
puts "create Movies, Lists and bookmarks"
...
Bookmark.create(comment: "Spielberg mastery oscar winning drama", movie_id: 2, list_id: 2)
Bookmark.create(comment: "based on Stephen King novel", movie_id: 4, list_id: 3)
